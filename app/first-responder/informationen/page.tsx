    ...
    <>
      <article>
        <FfPageSection headline="First Responder" id="responder" className="pb-6 sm:pb-8">
          ...
          <div className="mt-2">
            Das Ziel der First Responder ist es, das so genannte therapiefreie Intervall – also die Zeit zwischen Absetzen des Notrufs und Eintreffen des Rettungsdienstes – möglichst kurz zu halten. Dadurch erhöhen sich die
            Erfolgsaussichten für die Behandlung der Patienten deutlich. In der Zeit zwischen dem Eintritt des Notfalls und dem Eintreffen des Rettungsdienstes sollen die Betroffenen nicht ausschließlich auf zufällig geleistete Erste Hilfe
            angewiesen sein, sondern eine fachgerechte und sachkundige Erstversorgung erhalten.
          </div>
